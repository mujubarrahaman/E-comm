...
const Sidebar = () => {
    ...
    return (
        <div className='w-64  p-4 h-screen sticky top-0 overflow-y-auto shadow-inner sidebar '>
            <h2 className='text-xl font-semibold   mb-6' style={{color:"black"}}>Filters</h2>

            {/* Brand Filters */}
            <div className='mb-6  bg-gray-200' style={{height:'448.57px'}}>
                <h3 className=' font-semibold mb-4 p-4' style={{color:"black"}}>Hot Deals</h3>

                {brands.map((brand) => (
                    <label className='flex items-center mb-2 cursor-pointer p-4'>
                        <input
            ...
            {/* Price Range */}
            <div className='pt-6 p-4 mb-6  bg-gray-200' style={{height:'150px'}}>
                <h3 className=' font-semibold mb-3' style={{color:"black"}}>Price Range</h3>
